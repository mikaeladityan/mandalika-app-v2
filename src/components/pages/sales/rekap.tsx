...
import { Search, ChevronDown, Loader2, X, Download, Filter } from "lucide-react";
import {
    useSaleRekapQuery,
    useSaleRekapTableState,
} from "@/app/(application)/sales/server/use.sales";
import { SalesRekapListItemDTO } from "@/app/(application)/sales/server/sales.schema";
...
export function RekapSales() {
    const table = useSaleRekapTableState();
    const [columnVisibility, setColumnVisibility] = useLocalStorage<VisibilityState>(
        "sales-rekap-table-visibility",
        {},
    );
    ...
    const {
        ...
        isFetching,
        isRefetching,
    } = useSaleRekapQuery(table.queryParams);
        ...
        <section>
            <Card className="border-none shadow-xl shadow-slate-200/50 rounded-2xl overflow-hidden bg-white">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">
                                Laporan akumulasi penjualan produk per kategori
                            </p>
                        </div>
                    </div>
                ...
                <CardContent>
                    ...
                    <DataTable<SalesRekapListItemDTO, any>
                        tableId="sales-rekap-table"
                        columns={columns}
                        data={rekapData || []}
