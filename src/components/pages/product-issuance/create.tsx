                    ...
                    <Card className="border-none shadow-sm rounded-xl overflow-hidden">
                        ...
                        <CardContent className="grid gap-8 pt-8">
                            ...
                            <div className="bg-blue-50/50 border border-blue-100 p-4 rounded-xl flex gap-3">
                                <span className="p-1 px-2 h-fit text-[11px] font-bold bg-blue-100 text-blue-700 rounded-lg">PANDUAN</span>
                                <div className="text-xs text-blue-700 leading-relaxed">
                                    ...
                                    diinput sesuai dengan laporan pengeluaran aktual dari sistem POS
                                    atau Marketplace.
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <InputForm
                                    ...
                                    name="quantity"
                                    control={form.control}
                                    label="Total Quantity Dikeluarkan (Aktual)"
                                    type="number"
                        ...
                        <CardFooter className="p-6 pt-0">
                            ...
                            >
                                {isPending ? (
                                    ...
                                    <>
                                        Simpan Pengeluaran <Save className="ml-2 h-4 w-4" />
                                    </>
                                )}
                            </Button>
                        </CardFooter>
