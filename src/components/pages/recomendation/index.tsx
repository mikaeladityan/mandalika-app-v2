...
import { Boxes, Search, ChevronDown, Settings2, CalendarDays } from "lucide-react";
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3">
                            <div className="flex items-center gap-3 bg-white p-2 rounded-3xl border border-indigo-100 shadow-sm">
                                ...
                                <Select
                                    value={String(tableState.month || new Date().getMonth() + 1)}
                                ...
                                <Select
                                    value={String(tableState.year || new Date().getFullYear())}
