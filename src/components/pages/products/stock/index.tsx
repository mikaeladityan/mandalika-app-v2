...
import { useProductStockTableState } from "@/app/(application)/products/stocks/server/use.product.stock";
...
export function ProductsStock() {
    // Gunakan state stok produk yang baru mendukung month/year
    ...
    // Transformasi data ke bentuk baris per produk dan kolom per gudang
    ...
    return (
        <section className="space-y-6">
            <header className="space-y-1 mb-5">
                <h2 className="text-xl font-semibold tracking-tight">Rekap Stok Produk (FG)</h2>
                <p className="text-sm text-muted-foreground">
                    Lihat sebaran stok barang jadi di seluruh gudang perusahaan
                </p>
            </header>
