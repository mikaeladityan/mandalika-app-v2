            ...
            <Table>
                <TableHeader>
                    <TableRow className="bg-slate-50/50 hover:bg-slate-50/50">
                        ...
                        <TableHead className="font-semibold text-slate-700 text-center">GENDER</TableHead>
                        ...
                        <TableHead className="font-semibold text-slate-700 text-center">UNIT</TableHead>
                        <TableHead className="font-semibold text-slate-700 text-right">EDAR (%)</TableHead>
                        <TableHead className="font-semibold text-slate-700 text-right">SAFETY (%)</TableHead>
                ...
                <TableBody>
                    {rows.map((row, i) => (
                        ...
                        >
                            ...
                            <TableCell className="text-right font-mono text-xs">
                                {((row.safety_percentage ?? 0) * 100).toFixed(0)}%
                            </TableCell>
                            <TableCell>
