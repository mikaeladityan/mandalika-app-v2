...
function DialogDelete({ data }: { data: ResponseUnitDTO }) {
    const [confirm, setConfirm] = useState<string>("");
    const [err, setErr] = useState<string>("");
    const { remove } = useActionUnit();
        ...
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Apakah anda yakin untuk menghapus satuan produk{" "}
                ...
                <div>
                    ...
                    <Input
                        ...
                        value={confirm}
                        placeholder="Tulis kembali nama satuan"
