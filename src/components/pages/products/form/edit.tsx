...
import { ArrowLeft, Save, Box, RotateCcw, Loader2 } from "lucide-react";
            ...
            return (
                <div className={cn("space-y-4", className)}>
                    <div className="p-4 bg-primary/5 rounded-lg border border-primary/10 mb-2 italic">
                        <h3 className="text-sm font-bold flex items-center gap-1.5 italic">
                            {title}
                        </h3>
    ...
    const Actions = (
        <div className={cn("flex gap-2", !pageMode ? "pt-4 justify-end border-t" : "w-full sm:w-auto")}>
            ...
            >
                ...
                {pageMode ? "Simpan Perubahan Produk" : "Simpan"}
            </Button>
        </div>
    );
