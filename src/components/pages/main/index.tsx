    ...
    return (
        <div className="flex flex-col gap-[22px] animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <Card className="p-[22px] flex flex-col justify-between h-full bg-white border-[#E2E8F0] shadow-[0_10px_20px_rgba(15,23,42,0.06)] rounded-[18px]">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[13px] text-[#64748B] leading-relaxed max-w-[580px]">
                            Satu ekosistem terpadu untuk mengelola seluruh rantai pasokan parfum — mulai dari pengadaan bahan baku, formulasi resep beraliansi, produksi, hingga distribusi stok real-time ke seluruh outlet.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-[14px] mt-8">
                        <div className="p-[18px] border border-[#E2E8F0] rounded-[16px] bg-linear-to-b from-white to-[#FAFAFA]">
                            <div className="text-[10px] font-black uppercase tracking-widest text-[#64748B]">Produk SKU</div>
                            <div className="text-[24px] font-black text-[#0F172A] mt-2 leading-none">
                                {loadingProducts ? "..." : (products?.len ?? 0)}
                            </div>
                        </div>
                        <div className="p-[18px] border border-[#E2E8F0] rounded-[16px] bg-linear-to-b from-white to-[#FAFAFA]">
                            <div className="text-[10px] font-black uppercase tracking-widest text-[#64748B]">Bahan Baku</div>
                            <div className="text-[24px] font-black text-[#0F172A] mt-2 leading-none">
                                {loadingRawMat ? "..." : (rawMaterials?.len ?? 0)}
                            </div>
                        </div>
                        <div className="p-[18px] border border-[#E2E8F0] rounded-[16px] bg-linear-to-b from-white to-[#FAFAFA]">
                            <div className="text-[10px] font-black uppercase tracking-widest text-[#64748B]">Total Outlet</div>
                            <div className="text-[24px] font-black text-[#0F172A] mt-2 leading-none">
                                {loadingOutlets ? "..." : (outlets?.len ?? 0)}
                            </div>
                        </div>
                        <div className="p-[18px] border border-[#E2E8F0] rounded-[16px] bg-linear-to-b from-white to-[#FAFAFA]">
                            <div className="text-[10px] font-black uppercase tracking-widest text-[#64748B]">Tahap Proyek</div>
                            <div className="text-[14px] font-black text-[#10B981] mt-3 uppercase tracking-wider leading-none text-center">Fase 2</div>
                        </div>
                    </div>
                </Card>
                    ...
                    <Card className="p-[22px] bg-white border-[#E2E8F0] shadow-[0_10px_20px_rgba(15,23,42,0.06)] rounded-[18px]">
                        ...
                        <div className="space-y-1.5">
                            <p className="text-[12px] text-[#64748B] flex items-start gap-2">
                                <span className="font-bold text-[#0F172A]">1.</span> Stabilisasi Log Mutasi Stok
                            </p>
                            <p className="text-[12px] text-[#64748B] flex items-start gap-2">
                                <span className="font-bold text-[#0F172A]">2.</span> Implementasi PO & Receiving
                            </p>
                            <p className="text-[12px] text-[#64748B] flex items-start gap-2">
                                <span className="font-bold text-[#0F172A]">3.</span> Optimasi Resupply ke Outlet
                            </p>
                            <p className="text-[12px] text-[#64748B] flex items-start gap-2">
                                <span className="font-bold text-[#0F172A]">4.</span> Integrasi Real-time POS
                            </p>
                        </div>
                    </Card>
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-4">
                            <Link href="/warehouses" className="group">
                                <div className="p-3 border border-[#E2E8F0] rounded-[14px] hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/5 transition-all">
                                    <div className="text-[10px] font-black text-[#64748B] uppercase tracking-wider group-hover:text-[#D4AF37]">Gudang</div>
                                    <div className="text-[16px] font-black text-[#0F172A] mt-1">{loadingWarehouses ? "..." : (warehouses?.length ?? 0)}</div>
                                </div>
                            </Link>
                            <Link href="/outlets" className="group">
                                <div className="p-3 border border-[#E2E8F0] rounded-[14px] hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/5 transition-all">
                                    <div className="text-[10px] font-black text-[#64748B] uppercase tracking-wider group-hover:text-[#D4AF37]">Outlet Toko</div>
                                    <div className="text-[16px] font-black text-[#0F172A] mt-1">{loadingOutlets ? "..." : (outlets?.len ?? 0)}</div>
                                </div>
                            </Link>
                        </div>
                    </Card>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-5">
                ...
                <Card className="p-[22px] bg-white border-[#E2E8F0] shadow-[0_10px_20px_rgba(15,23,42,0.06)] rounded-[18px]">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <small className="text-[10px] font-black uppercase tracking-[0.14em] text-[#B49020]">Monitoring Sales</small>
                            <h2 className="text-[20px] font-black text-[#0F172A] mt-1">Pengeluaran Terlaris — {months[now.getMonth()]}</h2>
                        </div>
                        <Button variant="ghost" size="sm" asChild className="rounded-xl border-[#E2E8F0] hover:bg-[#F8FAFC]">
                            <Link href="/sales" className="text-xs font-bold text-[#64748B] flex items-center gap-1">
                    ...
                    {loadingSales ? (
                        ...
                        <div className="py-12 flex flex-col items-center justify-center text-center bg-gray-50/50 rounded-2xl border border-dashed border-[#E2E8F0]">
                            ...
                            <p className="text-[13px] font-medium text-[#94A3B8]">Belum ada data penjualan tercatat bulan ini</p>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {salesData.sales.map((sale: any, i: number) => (
                                <div key={i} className="flex items-center justify-between p-4 border border-[#E2E8F0] rounded-[16px] bg-white group hover:border-[#D4AF37]/40 transition-all">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-[#64748B] mt-1.5 font-medium"> SKU: {sale.product?.code ?? "-"}</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[14px] font-black text-[#0F172A]">{sale.totalQuantity ?? 0}</p>
                                        <p className="text-[10px] font-bold text-[#64748B] uppercase tracking-wider">Unit</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <div className="flex flex-col gap-5 min-w-[300px]">
                    <Card className="p-[22px] bg-[#0F172A] text-white border-none shadow-[0_20px_40px_rgba(15,23,42,0.2)] rounded-[18px] relative overflow-hidden h-full">
                        <div className="relative z-10 flex flex-col justify-between h-full">
                            <div>
                                <small className="text-[10px] font-black uppercase tracking-[0.14em] text-[#D4AF37]">System Health</small>
                                <h3 className="text-[18px] font-black mt-2">Sinkronisasi POS</h3>
                                <p className="text-[12px] text-gray-400 mt-2 leading-relaxed">
                                    Status koneksi ke outlet saat ini stabil. Menunggu deployment modul Sync di Fase 3.
                                </p>
                            </div>
            ...
            <section className="p-[22px] bg-white border-[#E2E8F0] shadow-[0_10px_20px_rgba(15,23,42,0.06)] rounded-[18px]">
                <div className="mb-6">
                    <small className="text-[10px] font-black uppercase tracking-[0.14em] text-[#B49020]">Master Project Roadmap</small>
                    <h2 className="text-[20px] font-black text-[#0F172A] mt-1">Tahapan Pengembangan Sistem</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[14px]">
                    {[
                        { f: "Fase 1: Core Foundation", d: "Produk SKU, Bahan Baku, Resep BOM, Forecasting Engine, dan Manajemen Outlet Dasar." },
                        { f: "Fase 2: Inventory Ops", d: "Log Mutasi Stok, Purchase Order (PO), Stock Transfer (Resupply), dan Stock Adjustment." },
                        { f: "Fase 3: POS Integration", d: "Registrasi POS Device, Sync Transaksi Penjualan, Idempotency, dan Auto-deduct Stok Toko." },
                        { f: "Fase 4: Alerts & Safety", d: "Low Stock Alert Otomatis (Gudang & Outlet), Safety Stock Calculation, dan Procurement Advice." },
                        { f: "Fase 5: Analytics", d: "Laporan Pergerakan Stok Universal, Analisis Slow Moving, dan Sinkronisasi Sales Actual." },
                        { f: "Fase 6: Finance", d: "Posting Akuntansi, AP/AR Tracking, Penjurnalan Otomatis, dan Laporan Laba Rugi." },
                    ].map((phase, i) => (
                        <div key={i} className="p-4 border border-[#E2E8F0] rounded-[16px] bg-white hover:shadow-md transition-all">
                            <h3 className="text-[14px] font-black text-[#0F172A] mb-2">{phase.f}</h3>
            ...
            <section className="p-[22px] bg-white border-[#E2E8F0] shadow-[0_10px_20px_rgba(15,23,42,0.06)] rounded-[18px]">
                <div className="mb-6">
                    <small className="text-[10px] font-black uppercase tracking-[0.14em] text-[#B49020]">Peta Modul</small>
                    <h2 className="text-[20px] font-black text-[#0F172A] mt-1">Modul Operasional Aktif</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[
                        { n: "Katalog Produk", s: "Manajemen produk jadi (Finish Goods) lengkap dengan ukuran dan tipe parfum.", h: "/products" },
                        { n: "Bahan Baku (RM)", s: "Kontrol stok Fragrance Oil (FO), packaging, dan aksesoris produksi.", h: "/rawmat" },
                        { n: "Resep & Formula", s: "Formulasi resep produk dari bahan baku dengan otomatisasi multiplier ukuran.", h: "/recipes" },
                        { n: "Forecasting", s: "Prediksi kebutuhan stok masa depan berdasarkan sales actual dan target pertumbuhan.", h: "/forecasts" },
                        { n: "Manajemen Outlet", s: "Kontrol distribusi stok dan inventaris real-time di setiap titik penjualan.", h: "/outlets" },
                        { n: "Purchasing", s: "Pengadaan bahan baku ke supplier dengan rekomendasi order otomatis.", h: "/purchase" },
                    ].map((mod, i) => (
                        <Link key={i} href={mod.h} className="group">
                            <div className="p-[14px_16px] border border-[#E2E8F0] rounded-[14px] bg-white group-hover:border-[#D4AF37]/40 group-hover:bg-[#D4AF37]/5 transition-all">
                                <div className="text-[13px] font-black text-[#0F172A] group-hover:text-[#D4AF37]">{mod.n}</div>
                                <div className="text-[11px] text-[#64748B] mt-1 group-hover:text-[#64748B]/80">{mod.s}</div>
                            </div>
                        </Link>
                    ))}
                </div>
