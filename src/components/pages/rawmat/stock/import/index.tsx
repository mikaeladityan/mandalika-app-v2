        ...
        <div className="space-y-6 w-full pb-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <h1 className="text-2xl font-bold tracking-tight text-slate-900">
                            Import Stok Material: {selectWarehouse?.name || "..."}
                        </h1>
                        <p className="text-sm text-muted-foreground">
                            Update atau sinkronisasi stok material di gudang secara massal.
                        </p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <Link
                        target="_blank"
                        href="https://docs.google.com/spreadsheets/d/14NuSAz7_yvtQC5CRs1rjgosyC6bXSfreZceiDmKZ4Rc/edit?usp=sharing"
                    >
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2">
                            ...
                            Konfirmasi Import Stok Material
                        </DialogTitle>
                        <DialogDescription>
